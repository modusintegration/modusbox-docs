...
*** xref:one-document-multiple-internal-routes-routing-scenario.adoc[One Document, Multiple Internal Routes Routing Scenario]
*** xref:multiple-internal-routes-routing-scenario.adoc[Multiple Internal Routes Routing Scenario]
