...
image::override-routing-scenario-artifacts-parta.png[img-override-routing-scenario-artifacts-parta, title="Shared Routing Scenario Artifacts in *_YourCompany_ B2B* : PartA"]

//.Override Routing Scenario Artifacts - *_YourCompany_ B2B* : A
