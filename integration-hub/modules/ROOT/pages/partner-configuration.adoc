...
To configure a partner or application relationship using PortX, you must:

. Configure settings for your company
+
NOTE: Your company may have been set up during the provisioning process. If so, its name appears at the top of the list on the  xref:img-partners-and-applications[], identified as *YOUR COMPANY*.

. Configure settings for a partner.
...
xref:img-partners-and-applications[]), click the name of your company.
+
