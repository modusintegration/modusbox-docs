...
+
[[img-transaction-workspace]]
image::transaction-workspace.png[img-transaction-workspace,title="Transaction Workspace Page"]
...
. Click *Save*.
+
The Source Channel card, populated with information based on what you added in the previous steps. 
Note that an *Incomplete* icon appears under *Resolutions*. 
. Click *Possible Endpoints*. 
+
The Source Document Page appears, opened at the *Resolutions* tab.  
