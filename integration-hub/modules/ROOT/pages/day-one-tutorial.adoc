...
=== Create Source Document for the Target Channel
...
image::td-transaction-design-page-target-channel-card-endpoint-overlay[img-td-transaction-design-page-target-channel-card-endpoint-overlay,title="Target Channel Card, Endpoint Overlay"]
