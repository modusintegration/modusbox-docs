...
In order to connect your application to Integration Hub, you must enter an xref:glossary#a[API Key] and environment Id.
...
Note: this file is no longer in the dir -  partials-tutorial-troubleshooting.adoc
