...
+
NOTE: If you are unable to access Integration Hub, see your Mulesoft account administrator for assistance.
...
In the tutorial, AcmeHomeSupply uses Integration Hub to order products from AAZFasteners. In the following sections, you will:
