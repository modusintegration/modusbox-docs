...
(xref:maps.adoc[Map], Schema, target xref:endpoint.adoc[Endpoint]) and adds this information to the context headers that travel with the message to be used by later stages.
