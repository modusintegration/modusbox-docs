...
Integration Hub provides a single web-based user interface for the key elements of service and partner management:

* <<Transaction Monitoring>>
* <<Partner Configuration>>
* <<Administration>>. 

link:six-days.adoc[Learn how you can deploy Integration Hub in Six Days].
