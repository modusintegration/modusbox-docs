...
<<<<<<< HEAD:partner-manager/modules/ROOT/pages/index.adoc
== Start Partner Manager
=======
////

== Start Integration Hub
>>>>>>> 0f39bfe... global change to integration hub:integration-hub/modules/ROOT/pages/index.adoc
