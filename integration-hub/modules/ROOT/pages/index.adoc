...
For more information, see xref:transaction-monitoring.adoc[Jordan - just see if you can recreate this link - it's okay if the page to which you link contains only a header].
