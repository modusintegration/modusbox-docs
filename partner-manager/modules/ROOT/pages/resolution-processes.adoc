...
for xref:b2b-transaction-processing-framework#document-type[document types], xref:b2b-transaction-processing-framework#endpoints[endpoints], and xref:routes[routes]. For example, you can configure
