...
This page identifies the PortX components you use to monitor transactions; see also xref:tracking-scenarios[Tracking Scenarios].

== Get Started

. xref:anypoint-partner-manager#start-anypoint-manager[Start PortX].
...
For information about elements that can appear within this pane, see xref:central-pane-elements[Central Pane elements].
