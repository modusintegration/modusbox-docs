...
This section shows you how to use the PortX user interface to create a lookup table. Alternatively, you can create a lookup table through calls to the xref:anypoint-partner-manager-api[PortX API]; see xref:lookup-tables-programmatic[Create a Lookup Table]. See xref:lookup-tables-programmatic[Create a Lookup Table] also for instructions for querying a table.
