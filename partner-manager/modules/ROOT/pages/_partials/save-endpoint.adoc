...
.xref:anypoint-partner-manager#start-anypoint-manager[Start APM].
The <<anypoint-partner-manager.adoc#img-partner-manager-start, B2B Transactions Page>> appears.
