...
+
The <<img-endpoint-settings>> appears. The settings that appear depend on the values for *Protocol* and *Type*.
+
...
+
When you have entered settings for *Name*, *Protocol* and *Type*, the <<img-endpoint-add>> becomes the <<img-endpoint-settings-b>>.
+
