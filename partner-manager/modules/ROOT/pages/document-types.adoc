...
include::{partialsdir}/edit-short.adoc[]
...
Valid values:: xref:glossary#sects[Standard PortX field format]
+
...
On the <<img-document-types>>, click *New Property*. The *Add Property* box appears.
