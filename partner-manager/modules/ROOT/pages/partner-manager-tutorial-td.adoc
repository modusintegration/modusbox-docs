...
* Anypoint Studio with Mule 3.9.0 and the following connectors:
** Partner Manager 7.0.0
** AS2 v2.3.0
** X12 v1.3.2
...
. Click save button on top right side to save the transaction.
...
. In the row that corresponds to the environment with which you are working, click on + icon to copy the value.
...
. On the *General* tab, in the *Mule domains/projects to launch* pane, select both *apm-routing-engine* and *AS2-partnermock*.
. Click *Run*. +
