...
* xref:lookup-tables#creating-a-lookup-table[PortX user interface]
...
----
+
NOTE: To query the lookup table from within a Mule flow, see xref:mule-user-guide/v/3.8/consuming-a-rest-api[Consuming a REST API].
...
For more information, see  xref:lookup-tables#working-with-a-lookup-table[Working with a Lookup Table].
