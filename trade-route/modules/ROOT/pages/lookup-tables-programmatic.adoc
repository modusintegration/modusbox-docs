...
* xref:portx/lookup-tables#creating-a-lookup-table[PortX user interface]
...
For more information, see  xref:portx/lookup-tables#working-with-a-lookup-table[Working with a Lookup Table].
