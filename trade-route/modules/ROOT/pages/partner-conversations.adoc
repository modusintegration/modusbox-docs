...
This page provides instructing for creating and editing Partner Conversations. For information about tracking Conversations, see  xref:portx/transaction-monitoring[Transaction Monitoring].
...
+
NOTE: For a property to appear in this list, it must have been defined in xref:portx/document-types[Document Types].
