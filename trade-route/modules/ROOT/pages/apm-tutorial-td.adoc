...
Type:: Source or Target, As created in xref:portx/maps[Channels] or in xref:portx/transaction-designer[Transaction Designer]. Source Channel settings are always specific to the origin of a document. Target Channel settings are always specific to the destination.
Document:: As created in xref:portx/document-types[Document Types] or in xref:portx/transaction-designer[Transaction Designer]
Document Map:: As created in xref:portx/maps[Maps] or in xref:portx/transaction-designer[Transaction Designer]
Endpoint:: As created in xref:portx/endpoints[Endpoints] or in xref:portx/transaction-designer[Transaction Designer]
...
In order to create a Mule project, you must enter an xref:portx/glossary#secta[API Key] and an .
...
* The xref:portx/as2-connector[AS2 Connector]
