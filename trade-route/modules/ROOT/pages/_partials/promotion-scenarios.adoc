...
This section identifies common scenarios for promoting partners from one environment to another. For more information, see xref:partner-configuration#promoting-a-partner[Promoting a Partner].
