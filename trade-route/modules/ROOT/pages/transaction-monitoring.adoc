...
This page identifies the PortX components you use to monitor transactions; see also xref:portx/tracking-scenarios[Tracking Scenarios].
...
+
To change the time period, see xref:portx/central-pane-elements#overview-for-em-timeframe-em-dropdown-list[Overview for _timeframe_ Dropdown List].
+
To change the type of data displayed, see xref:portx/central-pane-elements#view-dropdown-list[View Dropdown List].
...
For information about elements that can appear within this pane, see xref:portx/central-pane-elements[Central Pane elements].
