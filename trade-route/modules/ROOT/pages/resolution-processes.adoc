...
for xref:portx/b2b-transaction-processing-framework#document-type[document types], xref:portx/b2b-transaction-processing-framework#endpoints[endpoints], and xref:portx/routes[routes]. For example, you can configure
