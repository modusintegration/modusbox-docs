...
* *Company name* (see xref:portx/partners[Partners] and xref:portx/company-information[Company Information])
* *Standard* (see <<Format>>)
* *Version* (see <<Format>>)
...
|Select either of these checkboxes in order to use the values selected in the corresponding sections of xref:portx/x12-settings[x12-Settings].
...
|Select this checkbox in order to use the values selected in the corresponding sections of xref:portx/csv-settings[CSV-Settings].
...
Valid values:: xref:portx/glossary#sects[Standard PortX field format]
+
