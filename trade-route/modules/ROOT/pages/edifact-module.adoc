...
* Support for many xref:portx/supported-edi-document-types[common EDIFACT versions] out of the box
...
If you wish, you can also define your own schemas from scratch. See the xref:portx/edi-schema-language-reference[EDI Schema Language Reference] for more details.
