...
NOTE: This document describes the Mule 3 version of X12. For the Mule 4 version, see the xref:connectors/x12-edi-connector[X12 EDI Connector].
...
See xref:portx/edi-schema-language-reference[EDI Schema Language Reference] for more details.
