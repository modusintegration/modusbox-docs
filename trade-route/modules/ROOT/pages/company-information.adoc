...
. After you enter a contact type, you can enter the following contact-specific information. All fields are xref:portx/glossary#sects[standard PortX field format].
