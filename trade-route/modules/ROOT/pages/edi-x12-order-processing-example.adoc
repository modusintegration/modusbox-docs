...
This example shows how to process an X12 850 document, export data to a CSV file, and generate a 997 acknowledgement using the File endpoint, xref:portx/x12-module[X12 Module], xref:mule-user-guide/v/3.9/using-mel-with-batch-processing[Using MEL with Batch Processing] module, and xref:mule-user-guide/v/3.9/dataweave[DataWeave]. 
