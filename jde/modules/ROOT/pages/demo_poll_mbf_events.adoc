...
NOTE: Ensure you are running the most recently updated version of AnyPoint Studio before starting with a PortX JDE Connector project.
...
. Locate the JDE Connector and select *Poll Events*. 
...
. Give it a meaningful name (eg. Call Poll Customer Master Events).
