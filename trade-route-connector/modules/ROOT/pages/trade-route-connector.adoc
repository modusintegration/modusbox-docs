...
:keywords: b2b, edi, anypoint partner manager, apm, trade route connector, partner manager connector
...
Trade Route Connector provides connectivity to Anypoint Partner Manager (APM). The connector allows the management of APM-enabled connectors from APM and tracking of B2B exchanges.
...
. Enter in the *Environment ID* attribute the CloudHub environment you want Trade Route Connector to run in.
. Press *OK*.
