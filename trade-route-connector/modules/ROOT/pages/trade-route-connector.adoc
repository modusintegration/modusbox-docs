...
:keywords: b2b, edi, trade route, trade route connector
...
Trade Route Connector provides connectivity to Trade Route. The connector allows the management of APM-enabled connectors from APM and tracking of B2B exchanges.
