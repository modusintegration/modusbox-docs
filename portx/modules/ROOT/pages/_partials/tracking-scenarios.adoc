...
This section identifies examples in which PortX (PortX) is useful to track B2B exchanges. A basic knowledge of PortX is assumed; see xref:portx.adoc[PortX] for more information.
