...
Welcome to PortX! In order to get you started using PortX to integrate partners and applications, we've created a week-long digital integration tour with an PortX expert. Meet the expert and get started with PortX concepts in xref:day-0-video[this video]. Once you've watched it, you're ready to take the tour. 
