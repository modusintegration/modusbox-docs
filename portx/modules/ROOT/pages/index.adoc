...
In the most common scenario, PortX is used in conjunction with an Enterprise Service Bus (ESB), PortX Connector, and other connectors. Find information about this and other PortX use cases in xref:examples.adoc[Examples].

== Start PortX

. Login to PortX.
+
For PortX login information, see your PortX representative.
