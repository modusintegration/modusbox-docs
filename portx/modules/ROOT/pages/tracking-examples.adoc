...
This section identifies examples in which PortX (IHub) is useful to track B2B exchanges. A basic knowledge of Ihub is assumed; see xref:index.adoc[PortX] for more information.
